...
@DATASETS.register_module()
class FaceTopDownCocoWholeBodyDataset(TopDownCocoWholeBodyDataset):
    """CocoWholeBodyDataset dataset for top-down pose estimation.
    ...
    def _load_coco_keypoint_annotation_kernel(self, img_id):
        ...
        for obj in objs:
            ...
            joints_3d[:, :2] = keypoints[:, :2]
            joints_3d_visible[:, :2] = np.minimum(1, keypoints[:, 2:3] > 0)
            joints_3d_visible[:23, :] = 0
            joints_3d_visible[90:, :] = 0
...
@DATASETS.register_module()
class HandTopDownCocoWholeBodyDataset(TopDownCocoWholeBodyDataset):
    """CocoWholeBodyDataset dataset for top-down pose estimation.
