...
class DownLayer(nn.Module):
    ...
    def forward(self, x, pos, pos_orig, idx_agg, agg_weight, H, W, N_grid):
        ...
        x_down = self.block(x_down, pos_down, idx_agg_down, agg_weight_down, pos_orig, x_down, pos_down, idx_agg_down, agg_weight_down, H, W, conf_source=None)
